			...
			<view class="mycourses-body">
				<swiper :style="{ height: height }" :current="current" @change="swiperChange">
					<swiper-item v-for="(tab, i) in list" :key="i">
						<!-- 培训专区 -->
						<view class="mycourses-body-active" v-show="current == 0">
							...
							<view class="mycourses-body-zw" v-else>
								...
								<view class="mycourses-body-zw-m" @click="apply">{{ commonality.apply }}</view>
							</view>
						</view>
						<!-- 视频专区 -->
						<view class="mycourses-body-active" v-show="current == 1">
							...
							<view class="mycourses-body-zw" v-else>
								...
								<view class="mycourses-body-zw-m" @click="purchase">{{ commonality.purchase }}</view>
							</view>
						</view>
					</swiper-item>
				</swiper>
