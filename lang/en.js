...
export default {
	index: {
		placeholder: 'Please enter the keywords you need to search for',
		information: 'Latest news:',
		mainCourse: '免费大讲堂',
		introductory: 'The main course',
		compilations: 'Selected collection',
		future: 'Recent class',
		ranking: 'Top',
			ercourses:'Most popular courses,',
		...
		hintTitle: '购买须知',
		conversion: 'Immediately exchange',
		orderAffirm: 'Order confirmation',
		selectsite: 'Select delivery address',
		addsite: '+ Newly added shipping address',
		addInfo: 'Fill in the receiving information',
		consignee: 'The consignee',
		contactWay: 'contact',
		Provinces: 'Provinces',
		ProvincesSelet:'Provincial choice',
		address: 'Detailed address',
		addressInfo: 'Please fill in the detailed address',
		...
		Default:"默认",
		del:'删除',
		delTip:'Are you sure to clear this address?',
		Confirmchange:'Confirm exchange',
		Forcomplete:'兑换完成',
		ViewOrder:'查看订单',
		topUpPhone:'Please fill in the recharge number',
		confirmTip:'Note: Please check carefully and click Confirm.',
